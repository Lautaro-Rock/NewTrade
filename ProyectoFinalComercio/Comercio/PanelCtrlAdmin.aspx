  ...
  <div class="container-fluid">
    ...
    <asp:Panel ID="PanelVendedor" runat="server" Visible="false">
      <div class="row justify-content-center g-5 mb-5 row-height">
        ...
        <div class="col-md-4">
          <a href="HistorialVentas.aspx" style="text-decoration: none;">
            <div class="card card-custom">
              <img src="\images\cashflow.png" alt="Historial de ventas" class="card-img">
              <h5 class="card-title">Mi historial de ventas</h5>
            </div>
          </a>
        </div>
      </div>
